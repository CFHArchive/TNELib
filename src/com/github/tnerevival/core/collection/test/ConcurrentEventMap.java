 ...
 */
package com.github.tnerevival.core.collection.test;
 ...
 **/
public class ConcurrentEventMap<K, V> extends ConcurrentHashMap<K, V> {

  private MapListener<K, V> listener;
  private Map<K, V> map = new HashMap<>();
  private long lastRefresh = new Date().getTime();

  public ConcurrentEventMap() {
    super();
  }

  public ConcurrentEventMap(MapListener listener) {
    super();
